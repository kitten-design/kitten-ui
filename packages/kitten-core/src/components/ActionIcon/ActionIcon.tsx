...
import type { ActionIconRootProps, ActionIconRootVariants } from './ActionIcon.style';
...
export const ActionIcon = cpc<'button', ActionIconProps, { Group: typeof ActionIconGroup }>(
  (props, ref) => {
    const { children, loading, disabled, variant, colorPalette, ...others } = props;
