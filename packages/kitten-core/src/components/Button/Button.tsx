...
import type { ButtonInnerProps, ButtonRootProps, ButtonRootVariants } from './Button.style';
import { ButtonInner, ButtonLabel, ButtonLoading, ButtonRoot } from './Button.style';
...
export const Button = cpc<'button', ButtonProps, { Group: typeof ButtonGroup }>((props, ref) => {
  const {
    children,
    disabled,
    loading,
